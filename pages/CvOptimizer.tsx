...
export const CvOptimizer: React.FC = () => {
  ...
  return (
    <div className="h-[calc(100vh-64px)] flex flex-col bg-background">
      {/* Waqf Note */}
      <div className="w-full bg-primary text-white text-center text-xs py-1 z-50 opacity-90 shrink-0">
        {t('common.waqfNote')}
      </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              {(file || sessionId) && (
                <button
                  ...
                  className="text-gray-600 hover:text-white hover:bg-red-500 px-3 py-1.5 rounded-md transition-colors text-sm font-bold border border-gray-200 hover:border-red-500"
                  title="New Session"
                >
                  {t('common.createNewCv')}
                </button>
              )}
              {pdfPreview && (
                <button
