...
import { ArrowRight, ArrowLeft, FileCheck, Search, MessageCircle, Briefcase, Building2, User, ChevronRight } from 'lucide-react';
          ...
          <div className="animate-slideUp w-full">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl hover:border-blue-300 transition-all duration-300 group flex flex-col h-full">
               ...
               {/* Mock Future Service */}
               <div className="bg-gray-50/50 rounded-2xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center p-8 text-center min-h-[400px] h-full opacity-60 hover:opacity-100 transition-opacity cursor-not-allowed">
                <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mb-4">
                  <Briefcase size={32} className="text-gray-400" />
                </div>
                <h3 className="text-lg font-bold text-gray-500">{t('common.comingSoon')}</h3>
                <span className="mt-4 px-3 py-1 bg-gray-200 text-gray-500 text-xs font-bold rounded-full">{t('common.comingSoon')}</span>
              </div>
            </div>
          </div>
        )}
